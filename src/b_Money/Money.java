...
public class Money implements Comparable {
	...
	public String toString() {
		return getAmount() + " " + this.currency.getName();
	}
	...
	public Money add(Money other) {
		return new Money((int) ((this.getAmount()*100 + this.getCurrency().valueInThisCurrency((int) (other.getAmount()*100), other.getCurrency()))), this.getCurrency());
	}
	...
	public Boolean isZero() {
		return this.getAmount().equals(0.0);
	}
	/**
